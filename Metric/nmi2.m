function score = nmi2(true_labels, cluster_labels)
...
% 	special edition for overlapped ground-truth communities.
%   labels and return the value in 'score'.
%
%   Input    : true_labels    : N-by-k vector containing true labels
